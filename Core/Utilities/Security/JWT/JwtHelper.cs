...
namespace Core.Utilities.Security.JWT
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public AccessToken CreateToken(Usera user,/* int UserId,*/List<OperationClaim> operationClaims)
        {
        ...
        public JwtSecurityToken CreateJwtSecurityToken(TokenOptions tokenOptions, Usera user, SigningCredentials signingCredentials, List<OperationClaim> operationClaims/*, int UserId*/)
        {
        ...
        private IEnumerable<Claim> SetClaims(Usera user, List<OperationClaim> operationClaims/*,int userId*/)
        {
